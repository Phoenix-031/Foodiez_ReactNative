...
const ProfileScreen = () => {
  ...
  return (
    <SafeAreaProvider style={styles.container}>
      ...
      >
        <View>
          <Text style={{ color: "#e5e1d8", fontFamily: "Poppins-Bold", fontSize: 25 }}>Username</Text>
      ...
      <ScrollView style={{ width: "90%", flexDirection: "column" }}>
        ...
        <View style={{ backgroundColor: "#28293d", borderRadius: 12, paddingVertical: 10, paddingHorizontal: 10, marginTop: 10 }}>
          ...
          >
            ...
            <Text style={{ fontFamily: "Poppins-SemiBold", fontSize: 15, color: "#e5e1d8" }}>My Reviews</Text>
          </Pressable>
